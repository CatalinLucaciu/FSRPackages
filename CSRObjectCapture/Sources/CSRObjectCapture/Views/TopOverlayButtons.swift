...
private let logger = Logger(subsystem: Bundle.main.bundleIdentifier ?? "com.example.CSRObjectCapture", category: "TopOverlayButtons")
...
private struct ThumbnailView: View {
    ...
    private func getFirstImage(from url: URL) -> URL? {
        let imageFolderURL = url.appendingPathComponent(CaptureFolderManagerMyOwn.imagesFolderName)
